...
<?php changeTitle('Privacy Policy - FileDrive'); ?>
<div class="container" style="margin-top:30px;font-size:11pt;">
    <div class="card">
        ...
        <div class="card-body text-muted">
          ...
          <p><?= _NAME; ?> operates the <?= BASE_DOMAIN; ?> website, which provides the SERVICE.</p>
          ...
          <ul>
            <li>
              ...
              <p>We will access your Google Drive accounts for implementings our sharing concepts. Note : We just copying file that you want to download to your google drive account. We don't distrubing other files that you haves.</p>
              <p><?= _NAME; ?> want to :</p>
              <ul>
