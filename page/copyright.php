...
<?php changeTitle('Copyright Policy - WiMember'); ?>
<div class="container" style="margin-top: 30px;">
    <div class="card">
        <strong class="card-header bg-primary text-white text-center"><i class="glyphicon glyphicon-bullhorn"></i> Copyright Policy</strong>
        <div class="card-body text-muted">
          <p>WiMember ("WiMember") respects the intellectual property rights of others and expects its users to do the same. WiMember will respond expeditiously to claims of copyright infringement committed using the WiMember service and/or the WiMember website (the "Site") if such claims are reported to WiMember' Designated Copyright Agent identified in the sample notice below.</p>
          <p>If you are a copyright owner, authorized to act on behalf of one, or authorized to act under any exclusive right under copyright, please report alleged copyright infringements taking place on or through the Site by completing the following Notice of Alleged Infringement and delivering it to WiMember' Designated Copyright Agent. Upon receipt of Notice as described below, WiMember will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Site.</p>
          <p><strong>Notice of Alleged Infringement ("Notice").</strong></p>
          <ul>
            ...
            <li>A description of where the infringing material or activity that the Complainant is located on the Site, with enough detail that we may find it on the Site (e.g., unique URL to the file);</li>
          ...
          <p>Deliver this Notice, with all items completed, to WiMember' Designated Copyright Agent: via email: <b>wimember.com@gmail.com</b></p>
        </div>
    </div>
</div>
